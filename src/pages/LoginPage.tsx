            ...
            <div className="container" style={{ maxWidth: '520px' }}>
                ...
                {tab === 'login' && (
                    <div className="glass-card" style={{ padding: '2rem' }}>
                        ...
                        {/* Tier 1: Standard Login */}
                        <div className="form-group" style={{ marginBottom: '1rem' }}>
                            <label className="form-label">Email</label>
                            <input className="form-input" placeholder="name@example.com" value="newuser@gmail.com" readOnly />
                        </div>
                        <div className="form-group" style={{ marginBottom: '1.5rem' }}>
                            <label className="form-label">Password</label>
                            <input className="form-input" type="password" placeholder="••••••••" value="password123" readOnly />
                        </div>
                        <button onClick={() => handleQuickLogin('tier1-1')} className="btn btn-primary btn-lg" style={{ width: '100%', marginBottom: '1rem' }}>
                            Sign In (Tier 1)
                        </button>
                        ...
                        <div style={{ position: 'relative', textAlign: 'center', marginBottom: '1rem' }}>
                            ...
                            <span style={{ position: 'relative', background: 'var(--bg-card)', padding: '0 0.5rem', fontSize: '0.75rem', color: 'var(--text-muted)' }}>OR</span>
                        </div>

                        <button onClick={() => handleQuickLogin('tier1-2')} className="btn btn-secondary btn-lg" style={{ width: '100%', marginBottom: '1.5rem', display: 'flex', gap: '0.5rem', alignItems: 'center', justifyContent: 'center' }}>
                        ...
                        <div style={{ position: 'relative', textAlign: 'center', marginBottom: '1rem' }}>
                            <div style={{ position: 'absolute', top: '50%', left: 0, right: 0, height: '1px', background: 'var(--border-subtle)' }} />
                            <span style={{ position: 'relative', background: 'var(--bg-card)', padding: '0 0.5rem', fontSize: '0.75rem', color: 'var(--text-muted)' }}>PREMIUM VERIFIED</span>
                        </div>

                        {/* UAE PASS Login — Tier 2 */}
                        <button onClick={handleUaePassLogin} className="btn btn-uaepass btn-lg" style={{ width: '100%', marginBottom: '1.5rem', gap: '0.75rem' }}>
                            <UaePassIcon /> Login with UAE PASS (Tier 2)
                        </button>
