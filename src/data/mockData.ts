...
export const users: User[] = [
    ...
    },
    {
        ...
        compliance: { kyc_status: 'pending', aml_status: 'pending', pep_status: 'pending', verified: false },
        is_verified: false, has_gcc: false, gccScore: 0, isPremium: false,
        resident_role: 'residing',
        current_house_id: 'P003',
        rent_monthly: 800, deposit: 800,
        tenancy_duration_months: 2,
    ...
    // ── Tier 1 Demo Users (Email-only, no UAE PASS) ───────────
    {
        ...
        is_verified: false, has_gcc: false, gccScore: 0, isPremium: false,
        resident_role: 'residing',
        current_house_id: 'P001',
        rent_monthly: 500, deposit: 500,
        tenancy_duration_months: 3,
...
export const listings: Listing[] = [
    // ── AED 500 - 800: Budget Private Rooms ─────────────────────────────────────────
    {
        ...
        address: 'Al Rigga Road, Deira', district: 'Deira', rent_per_room: 500, total_rooms: 3, available_rooms: 2,
        images: ['https://images.unsplash.com/photo-1585412727339-54e4bae3bbf9?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1560185007-cde436f6a4d0?w=800&h=500&fit=crop'], description: 'Clean, municipality-permitted private room in a 3-bedroom shared apartment. 3 mins walk to Al Rigga Metro. Daily cleaning included. One tenant per room.',
        ...
        current_roommates: ['S008'],
        occupancy_status: [
            { room_number: 1, tenant_id: 'S008', status: 'occupied' },
    ...
    },
    {
        ...
        address: 'Damascus St, Al Qusais', district: 'Al Qusais', rent_per_room: 800, total_rooms: 4, available_rooms: 3,
    ...
    // ── AED 1800 - 2500: Private Rooms (Budger / Mid-Tier) ────────────────────
    {
        ...
        images: ['https://images.unsplash.com/photo-1630699144867-37acec97df5a?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1567767292278-a4f21aa2d36e?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1598928506311-c55ece5ffa7d?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1586105251261-72a756497a11?w=800&h=500&fit=crop'], description: 'Your own private room in a massive JVC villa. Shared backyard, huge kitchen. You share a bathroom with just 1 other person.',
    ...
    },
    {
        ...
        images: ['https://images.unsplash.com/photo-1630699144867-37acec97df5a?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1567767292278-a4f21aa2d36e?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1598928506311-c55ece5ffa7d?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1586105251261-72a756497a11?w=800&h=500&fit=crop'], description: 'Clean, modern private room in DSO. Perfect for tech workers. Building has a great gym and rooftop pool.',
    ...
    },
    {
        ...
        images: ['https://images.unsplash.com/photo-1630699144867-37acec97df5a?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1567767292278-a4f21aa2d36e?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1598928506311-c55ece5ffa7d?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1586105251261-72a756497a11?w=800&h=500&fit=crop'], description: 'Awesome private room with en-suite. 5 mins walk to Mall of the Emirates Metro. Completely full at the moment.',
    ...
    // ── AED 2800 - 3500: Premium Private En-suites ────────────────────────────
    {
        ...
        images: ['https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1600566753086-00f18fb6b3ea?w=800&h=500&fit=crop'], description: 'High-floor private room overlooking the canal. Premium building amenities. You share the apartment with a verified pilot.',
    ...
    },
    {
        ...
        images: ['https://images.unsplash.com/photo-1630699144867-37acec97df5a?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1567767292278-a4f21aa2d36e?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1598928506311-c55ece5ffa7d?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1586105251261-72a756497a11?w=800&h=500&fit=crop'], description: 'Upgraded luxury apartment in JLT. Sweeping views of the golf course and lakes. Two empty private rooms available for immediate move-in.',
    ...
    },
    {
        ...
        images: ['https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1600607687644-aac4c3eac7f4?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1600566753190-17f0baa2a6c3?w=800&h=500&fit=crop', 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=800&h=500&fit=crop'], description: 'The absolute best of NestMatch. 3500 AED gets you an ocean-facing massive en-suite in the Marina. Full cleaning, all bills, gym, and pool included.',
...
export const chatChannels: ChatChannel[] = [
    ...
    // ── Property Chats for lower-tier residents ──
    {
        id: 'ch-prop-p001', listing_id: 'P001', name: 'Deira Apartment — House Chat',
        channel_type: 'property',
        participants: ['S008', 'L001', 'A002'],
        created_at: '2026-03-01',
        last_message: { id: 'msg-prop-p001-2', channel_id: 'ch-prop-p001', sender_id: 'L001', message_type: 'text', content: 'Welcome to the apartment Liam! Let me know if you have any questions.', read_by: ['L001', 'A002'], created_at: '2026-03-02T09:00:00Z' },
    },
    {
        id: 'ch-prop-p003', listing_id: 'P003', name: 'Al Qusais — House Chat',
        channel_type: 'property',
        participants: ['S006', 'L002', 'A001'],
        created_at: '2026-03-05',
        last_message: { id: 'msg-prop-p003-2', channel_id: 'ch-prop-p003', sender_id: 'S006', message_type: 'text', content: 'Thanks Fatima! The place is lovely. Quick question — is there a laundry room in the building?', read_by: ['S006'], created_at: '2026-03-06T14:00:00Z' },
    },
...
export const chatMessages: ChatMessage[] = [
    ...
    // ── Property Chat: P001 Deira (Liam's home) ──
    { id: 'msg-prop-p001-1', channel_id: 'ch-prop-p001', sender_id: 'S008', message_type: 'text', content: 'Hi! Just settling in. The metro is literally 3 minutes away — class location.', read_by: ['S008', 'L001'], created_at: '2026-03-02T08:30:00Z' },
    { id: 'msg-prop-p001-2', channel_id: 'ch-prop-p001', sender_id: 'L001', message_type: 'text', content: 'Welcome to the apartment Liam! Let me know if you have any questions.', read_by: ['L001', 'A002'], created_at: '2026-03-02T09:00:00Z' },
    // ── Property Chat: P003 Al Qusais (Sofia's home) ──
    { id: 'msg-prop-p003-1', channel_id: 'ch-prop-p003', sender_id: 'L002', message_type: 'text', content: 'Welcome Sofia! Keys are at the reception. Call Khalid if you need anything.', read_by: ['L002', 'A001', 'S006'], created_at: '2026-03-05T10:00:00Z' },
    { id: 'msg-prop-p003-2', channel_id: 'ch-prop-p003', sender_id: 'S006', message_type: 'text', content: 'Thanks Fatima! The place is lovely. Quick question — is there a laundry room in the building?', read_by: ['S006'], created_at: '2026-03-06T14:00:00Z' },
