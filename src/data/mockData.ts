...
export const users: User[] = [
    // ── Landlord 1: Ahmed Al Maktoum ──────────────────────────
    {
        ...
        name: 'Ahmed Al Maktoum', email: 'ahmed.almaktoum@nestmatch.ae', avatar: '', nationality: 'Emirati',
    ...
    // ── Landlord 2: Fatima Hassan ──────────────────────────────
    {
        ...
        isUaePassVerified: true, isIdVerified: false, verification_tier: 'tier2_uae_pass',
        name: 'Fatima Hassan', email: 'fatima.hassan@nestmatch.ae', avatar: '', nationality: 'Emirati',
    ...
    // ── Residing Roommate 1: Priya Sharma ─────────────────────
    {
        ...
        isUaePassVerified: true, isIdVerified: false, verification_tier: 'tier2_uae_pass',
        name: 'Priya Sharma', email: 'priya.sharma@email.com', avatar: '', nationality: 'Indian',
    ...
    // ── Tier 0 Demo Users (Passport KYC, no Emirates ID) ────────
    {
        ...
        name: 'James Okafor', email: 'james.okafor@gmail.com', avatar: '',
    ...
    },
    {
        ...
        isUaePassVerified: false, isIdVerified: false,
        verification_tier: 'tier0_passport',
        name: 'Sofia Kowalski', email: 'sofia.k@outlook.com', avatar: '',
    ...
    // ── Tier 1 Demo Users (Email-only, no UAE PASS) ───────────
    {
        ...
        name: 'Liam O\'Brien', email: 'liam.obrien@gmail.com', avatar: '', nationality: 'Irish',
...
export const listings: Listing[] = [
    ...
    },
    {
        ...
        tags: ['bed-space', 'budget'], listing_status: 'active', makaniNumber: '2233445566', trakheesiPermit: 'TRAK-2025-IC-123', municipalityPermit: 'DM-SH-2026-IC1',
    ...
    },
    {
        ...
        tags: ['bed-space', 'dafza'], listing_status: 'active', makaniNumber: '3344556677', trakheesiPermit: 'TRAK-2025-AQ-123', municipalityPermit: 'DM-SH-2026-AQ1',
    ...
    // ── AED 1000 - 1500: Shared Rooms (2-3 pax) ───────────────────────────────
    {
        ...
        tags: ['shared-room', 'bur-dubai', 'twin'], listing_status: 'active', makaniNumber: '4455667788', trakheesiPermit: 'TRAK-2025-BD-123', municipalityPermit: 'DM-SH-2026-BD1',
    ...
    // ── Coming Soon Listings ─────────────────────────────────────────────────────
    {
        ...
        images: [], description: 'Luxury studio with full Burj Khalifa view. Launching on NestMatch next month.',
    ...
    },
    {
        ...
        images: [], description: 'Private room in a stunning Palm villa with beach access. Coming to NestMatch soon — register interest now.',
