...
export interface User {
    id: string;
    type?: UserType;
    role?: string;              // UI Alias for role (landlord, agent, roommate)
    auth_method?: AuthMethod;
    authTier?: number;          // UI Alias for tiered auth (1 or 2)
...
export interface Listing {
    ...
    dldPermit?: string;           // UI Alias for trakheesiPermit
...
export type ViewingStatus =
    ...
    | 'ACCEPTED';                // UI Status for accepted viewings
...
export interface ViewingBooking {
    ...
    holdAuthorized?: boolean;      // UI Alias
